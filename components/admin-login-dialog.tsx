...
export function AdminLoginDialog() {
  ...
  return (
    <Dialog open={isDialogOpen} onOpenChange={(open) => !open && closeDialog()}>
      <DialogContent className="sm:max-w-md rounded-3xl p-6 bg-white border-slate-200 shadow-xl">
        ...
        <div className="space-y-4 py-2">
          <div className="space-y-1.5">
            ...
            <Input
              ...
              className="h-11 rounded-2xl bg-slate-50 border-slate-200 text-center font-mono tracking-widest text-base"
              autoFocus
            />
          </div>
